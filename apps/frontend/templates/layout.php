...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
	<title>
		<?php include_slot('title', 'Stackend - Your best local info sharing board') ?>
	</title>
		...
		-->
            ...
            <div class="search">
				...
				<form action="<?php echo url_for('job_search') ?>" method="get">
				  ...
				  <div class="help">
					Enter some keywords (city, company, position, ...)
				  </div>
				</form>
            </div>
          </div>
      ...
      <div id="footer">
        <div class="content">
			...
			<ul>
            	...
            	<li class="last"><a href="/backend.php">Admin</a></li>
&copy; <?php echo date("Y"); ?> ourbf Copyright.
          </ul>
