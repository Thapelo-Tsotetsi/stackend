...
abstract class BaseJobGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%is_activated%% <small>%%StackendCategory%%</small> - %%company%% (<em>%%email%%</em>) is looking for a %%=position%% (%%location%%)';
  }
