...
abstract class autoJobActions extends sfActions
{
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->stackend_job = $this->form->getObject();
  }
  ...
  {
    $this->stackend_job = $this->getRoute()->getObject();
    $this->form = $this->configuration->getForm($this->stackend_job);
  }
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'StackendJob'));
    try
    {
      // validate ids
  ...
  protected function processForm(sfWebRequest $request, sfForm $form)
  {
    ...
    if ($form->isValid())
    {
      ...
      $this->dispatcher->notify(new sfEvent($this, 'admin.save_object', array('object' => $stackend_job)));

      if ($request->hasParameter('_save_and_add'))
      {
        $this->getUser()->setFlash('notice', $notice.' You can add another one below.');

        $this->redirect('@stackend_job_new');
      }
      else
      {
        $this->getUser()->setFlash('notice', $notice);

        $this->redirect(array('sf_route' => 'stackend_job_edit', 'sf_subject' => $stackend_job));
      }
    }
    else
    {
  ...
  {
    $pager = $this->configuration->getPager('StackendJob');
  ...
  {
    return Doctrine_Core::getTable('StackendJob')->hasColumn($column);
  }
}
