...
/**
 * StackendContribution filter form base class.
 *
 * @package    stackend
 * @subpackage filter
 ...
 */
abstract class BaseStackendContributionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'category_id'  => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('StackendCategoryContribution'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'category_id'  => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('StackendCategoryContribution'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('stackend_contribution_filters[%s]');
