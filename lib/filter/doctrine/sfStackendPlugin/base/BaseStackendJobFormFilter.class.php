...
/**
 * StackendJob filter form base class.
 *
 * @package    stackend
 * @subpackage filter
 ...
 */
abstract class BaseStackendJobFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'category_id'  => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('StackendCategory'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'category_id'  => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('StackendCategory'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('stackend_job_filters[%s]');
